		...
		super(client, {
			...
			args: [
				...
				},
				{
					...
					type: 'string',
					// oneOf converts to lowercase, which is icky with units, use validate.
					validate: u => types.includes(u),
				},
				{
					key: 'secondUnit',
					...
					type: 'string',
					// oneOf converts to lowercase, which is icky with units, use validate.
					validate: u => types.includes(u) || u === 'to',
				},
				{
